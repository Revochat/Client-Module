...
const client = new __1.default.Client(); // Create a new client for the sender of the message
const client2 = new __1.default.Client(); // Create a new client for the receiver of the message
